export default function BookList() {
   ...
   return (
      <div>
         <h3>{pageTitle}</h3>
         <img src={book1} alt="He who fights with monsters by Shirtaloon and Travis Deverell" />
         <img src={book2} alt="Defiance of the fall by TheFirstDefier and JF Brink" />
         <img src={book3} alt="The path of the Berserker by Rick Scott " />
      </div>      
   );
}